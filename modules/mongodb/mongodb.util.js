(function () {
  ...
  function init() {
    var options = {}; // No options needed for latest MongoDB driver versions
  ...
  function prepareConnectionString(config) {
    ...
    // Add the authentication database (authSource) here
    connectionString += "?authSource=admin"; // Change 'admin' if your auth DB is different
